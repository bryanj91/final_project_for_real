...
var wolf = makeImage("https://s3-us-west-2.amazonaws.com/s.cdpn.io/695916/husky.gif", 5, 155, 50, 70)

var line1 = makeRect(100, 170, 4, 30, "gray")

var line2 = makeRect(190, 0, 4, 150, "gray")

var line3  = makeRect(280, 170, 4, 30, "gray")

var shape4 = makeEllipse(125, 175, 10, 10, "red", 0.50)
...
function moveL1(){
  ...
  if (collides(wolf, line1)) {
    alert("game over")
  } else if (collides(wolf,line2)) {
    alert("game over")
  } else {
   requestAnimationFrame(moveL1)
  }
...
addEventListener('keydown', moveWolf)
